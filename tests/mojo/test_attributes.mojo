...
fn test_attribute_scalar() raises:
    fn test_float32() raises:
        ...
        assert_true(a1.to_scalar[DType.float32]() == value_a, "Float32 scalar attribute failed")

        alias value_b: Float64 = 65151
        alias a2 = Attribute(name="test", value=value_b)
        assert_true(a2.to_scalar[DType.float32]() == value_b, "Float32 scalar attribute failed")

    fn test_float64() raises:
        alias value_a: Float64 = -1.23456
        alias a1 = Attribute(name="test", value=value_a)
        assert_true(a1.to_scalar[DType.float64]() == value_a, "Float64 scalar attribute failed")

        alias value_b: Float64 = 123456
        alias a2 = Attribute(name="test", value=value_b)
        assert_true(a2.to_scalar[DType.float64]() == value_b, "Float64 scalar attribute failed")

    fn test_int32() raises:
        alias value_a: Int32 = 666
        alias a1 = Attribute(name="test", value=value_a)
        assert_true(a1.to_scalar[DType.int32]() == value_a, "Int32 scalar attribute failed")

        alias value_b: Int32 = -666
        alias a2 = Attribute(name="test", value=value_b)
        assert_true(a2.to_scalar[DType.int32]() == value_b, "Int32 scalar attribute failed")

    fn test_attribute_small_scalar() raises:
        alias value_a: Float32 = 1e-18
        alias a = Attribute(name="test", value=value_a)
        assert_true(a.to_scalar[DType.float32]() == value_a, "SMALL scalar attribute failed")
