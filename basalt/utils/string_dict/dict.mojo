...
struct StringDict[
    ...
    fn __init__(inout self, capacity: Int = 16):
        ...
        if capacity <= 8:
            ...
            self.capacity = (
                capacity if ctpop(icapacity)
                == 1 else 1 << (bit_length(icapacity)).to_int()
            )
    ...
    fn put(inout self, key: String, value: V):
        ...
        while True:
            ...
            if key_index == 0:
                ...
                self.count += 1
                self.key_map.store(
                    key_map_index, SIMD[KeyCountType, 1](self.keys.count)
                )
                return
    ...
    fn _rehash(inout self):
        ...
        for i in range(old_capacity):
            ...
            if caching_hashes:
                ...
                key_hash = hash(self.keys[(old_key_map[i] - 1).to_int()]).cast[
                    KeyCountType
                ]()
